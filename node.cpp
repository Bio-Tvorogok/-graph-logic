...
Node::Node(GraphWidget *graphWidget, QString text, bool is_show_id)
    : NodeEdgeParent(graphWidget, _idStatic++, text, is_show_id)
{
...
void Node::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
    ...
    painter->setBrush((option->state & QStyle::State_Selected ? Qt::cyan: _color));
    _pen.setColor(_color == Qt::black ? Qt::white: Qt::black);
    painter->setPen(_pen);

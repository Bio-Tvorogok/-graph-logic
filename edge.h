...
{
protected:
    EdgeParent(Node *sourceNode, Node *destNode = nullptr, QString text = nullptr, bool is_show_id = false, bool is_directed = true);
...
{
public:
    Edge(Node *sourceNode, Node *destNode = nullptr, QString text = nullptr, bool is_show_id = false, bool is_directed = true);
...
{
public:
    EdgeCircle(Node *sourceNode, QString text = nullptr, bool is_show_id = false, bool is_directed = true);
